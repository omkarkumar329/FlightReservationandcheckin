package com.omkar.flightreservation.util;
...
public class EmailUtil {
	@Value("${com.omkar.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached.";

	@Value("${com.omkar.flightreservation.itinerary.email.subject}")
